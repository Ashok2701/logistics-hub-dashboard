      ...
      <DataTableShell>
        <table className="data-table">
          <thead><tr>
            ...
            <SortableTh sortKey="license" sort={sort}>License</SortableTh>
            <SortableTh sortKey="phone" sort={sort}>Phone</SortableTh>
            <SortableTh sortKey="status" sort={sort}>Status</SortableTh>
            <SortableTh sortKey="trips" sort={sort}>Total Trips</SortableTh>
